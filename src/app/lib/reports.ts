...
export function formatBookingForReport(booking: any): Record<string, unknown> {
...
export function formatDoctorReport(doctors: any[], bookings: any[]): Record<string, unknown>[] {
